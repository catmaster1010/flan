...
void gdt_init() {
    ...
    gdt[1] = (gdt_entry_t){// ring 0 16 code
                           .limit = 0xffff, .baselow16 = 0,   .basemid8 = 0,
                           .access = 0x9a,  .granularity = 0, .basehigh8 = 0};

    gdt[2] = (gdt_entry_t){// ring 0 16 data
                           .limit = 0xffff, .baselow16 = 0,   .basemid8 = 0,
                           .access = 0x92,  .granularity = 0, .basehigh8 = 0};

    gdt[3] =
        (gdt_entry_t){// ring 0 32 code
                      .limit = 0xffff, .baselow16 = 0,      .basemid8 = 0,
                      .access = 0x9a,  .granularity = 0xcf, .basehigh8 = 0};

    gdt[4] =
        (gdt_entry_t){// ring 0 32 data
                      .limit = 0xffff, .baselow16 = 0,      .basemid8 = 0,
                      .access = 0x92,  .granularity = 0xcf, .basehigh8 = 0};

    // actual standard gdt entries follow (kernel, user)

    gdt[5] = (gdt_entry_t){// kernel 64 code
                           .limit = 0,     .baselow16 = 0,      .basemid8 = 0,
                           .access = 0x9a, .granularity = 0x20, .basehigh8 = 0};
    ...
    gdt[7] = (gdt_entry_t){// user 64 data
                           .limit = 0,     .baselow16 = 0,   .basemid8 = 0,
                           .access = 0xf2, .granularity = 0, .basehigh8 = 0};

    gdt[8] = (gdt_entry_t){// user 64 code
                           .limit = 0,     .baselow16 = 0,      .basemid8 = 0,
                           .access = 0xfa, .granularity = 0x20, .basehigh8 = 0};

    gdt[9] = (gdt_entry_t){.limit = 104,
                           .baselow16 = 0,
                           .basemid8 = 0,
                           .basehigh8 = 0,
                           .access = 0x89,
...
void gdt_load_tss(tss_t *tss) {
    ...
    gdt[9] = (gdt_entry_t){.limit = 104,
                           ...
                           .access = 0x89,
                           .granularity = 0x00};
    gdt[10] = (gdt_entry_t){.limit = (uint16_t)((uint64_t)tss >> 32),
